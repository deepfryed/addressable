...
adds support for IRIs and URI templates.
  ...
  s.files = ["lib/addressable", "lib/addressable/template.rb", "lib/addressable/uri.rb", "lib/addressable/idna.rb", "lib/addressable/version.rb", "spec/addressable", "spec/addressable/template_spec.rb", "spec/addressable/idna_spec.rb", "spec/addressable/uri_spec.rb", "spec/data", "spec/data/rfc3986.txt", "tasks/clobber.rake", "tasks/rdoc.rake", "tasks/yard.rake", "tasks/git.rake", "tasks/gem.rake", "tasks/metrics.rake", "tasks/rubyforge.rake", "tasks/spec.rake", "website/index.html", "LICENSE", "README", "CHANGELOG", "Rakefile"]
